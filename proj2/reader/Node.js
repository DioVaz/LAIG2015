...
Node.prototype.update = function(currTime){
    ...
    //ALTERAR
	if(this.id == 'waterHouse'){

     return animateTransformation = this.animations["linearMove"].update(currTime);
      
	 //mat4.multiply(this.localTransformations, this.localTransformations, animateTransformation);
    }
